...
100 format (A,"(",A,"): ",A)
  ...
  subroutine help_me()
    ...
    write (uout,'("")')
    write (uout,'("  RUN FIT n.i [MAXNORM mn.r] [MAXCOEF mc.r] [MAXENERGY e1.i ene1.r e2.i ene2.r ...]")')
    write (uout,'("              [MINL l.i s.i p.i ...] [MAXL l.i s.i p.i]")')
    ...
    write (uout,'("")')
    write (uout,'("  RUN FITL n.i [MAXNORM mn.r] [MAXCOEF mc.r] [MAXENERGY e1.i ene1.r e2.i ene2.r ...]")')
