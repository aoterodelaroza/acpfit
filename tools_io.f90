...
100 format (A,"(",A,"): ",A)
  ...
  subroutine help_me()
    ...
    write (uout,'("")')
    write (uout,'("  RUN FIT n.i [MAXNORM mn.r] [MAXCOEF mc.r] [MAXENERGY ene.r e1.i e2.i ...]")')
    ...
    write (uout,'("    * If MAXNORM is present, discard the combinations where the norm of the resulting")')
    ...
    write (uout,'("      an energy contribution larger than ene.r for any of the indicated systems, identified")')
    write (uout,'("      by the integers e1.i, e2.i, etc. from the system list.")')
