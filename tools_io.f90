...
100 format (A,"(",A,"): ",A)
  ...
  subroutine help_me()
    ...
    write (uout,'("")')
    write (uout,'("  FILE ADD addfile.s ")')
    write (uout,'("    Add the contents of a file as an additonal energy contribution. The energies in")')
    write (uout,'("    this file will be added to the ACP contribution. They are associated with a")')
    write (uout,'("    coefficient that is optimized during the fit. Useful for additional energies,")')
