...
100 format (A,"(",A,"): ",A)
  ...
  subroutine help_me()
    ...
    write (uout,'("")')
    write (uout,'("  RUN FIT n.i [MAXNORM mn.r] [MAXCOEF mc.r]")')
    ...
    write (uout,'("    minimizes the error. If MAXNORM is present, discard the combinations where the norm of the")')
    write (uout,'("    resulting coefficients exceeds mn.r. If MAXCOEF is present, discard the combinations")')
