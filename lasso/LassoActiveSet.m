function [w,iteration] = LassoActiveSet(X, y, t,varargin)
...
[maxIter,verbose,optTol,threshold,mode,w0] = process_options(varargin,'maxIter',10000,'verbose',0,'optTol',1e-5,'zeroThreshold',1e-4,'mode',0,'w0',[]);
[n p] = size(X);
iteration = 0;
sigma_old = ones(p,1);
XX = X'*X;
